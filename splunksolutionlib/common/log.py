...
def log_enter_exit(logger):
    """
    Log decorator to log function enter and exit, this decorator will
    generate a lot of debug log, please as this only when it is required
...
@singleton
class Logs(object):
    """This class is a singleton that manage all the loggers, all the log file will
    be written to [splunk_home]/var/log/splunk

    :param namespace: the namespace used by the logging ( default is None )
    :param default_level: the default logging level (default is logging.INFO)
    ...
    def get_logger(self, name, level=None, max_bytes=25000000, backup_count=5):
        ...
        :param max_bytes: The maximum log file size before rollover
        :param backup_count: The number of log files to retain
