...
class TestServerInfo(object):
    _mock_server_info_property = {'server_roles': ['cluster_search_head', 'search_head', 'kv_store', 'shc_captain'], 'version': '6.3.1511.2'}

    def test_is_captain(self, monkeypatch):
        monkeypatch.setattr(client.Service, 'info', self._mock_server_info_property)
    ...
    def test_get_shc_members(self, monkeypatch):
        ...
        monkeypatch.setattr(binding.Context, 'get', _mock_server_info_get)
